...
class Alphabet(object):
	...
	def from_dict(cls, alphabet_dictionary):
		...
		"""
		alphabet = cls()
		alphabet._label_to_index = dict([(eval(key),value) if key[0] =='(' else (key,value) for key,value in alphabet_dictionary['_label_to_index'].items()])
